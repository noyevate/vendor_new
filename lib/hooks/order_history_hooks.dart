...
FetchHook orderHistoryHooks(String restaurantId) {
  ...
  Future<void> fetchData() async {
    ...
    try {
      final url = Uri.parse("$appBaseUrl/api/order/restaurant/status/$restaurantId");
    ...
    Map<String, String> headers = {
      ...
      debugPrint("Fetch new order status code: ${response.body}");
