...
bool _parseBool(dynamic value, {required String fieldName}) {
  print(
      "Parsing bool for '$fieldName': received value -> '$value' of type -> ${value.runtimeType}");
  if (value is bool) return value;
  if (value is String) return value.toLowerCase() == 'true';
  if (value is int) return value == 1;
  return false;
...
class LoginResponseModel {
  ...
  factory LoginResponseModel.fromJson(Map<String, dynamic> json) =>
      LoginResponseModel(
        ...
        fcm: json["fcm"] ?? "",
        verification:
            _parseBool(json["verification"], fieldName: "verification"),
        phone: json["phone"] ?? '',
        phoneVerification: _parseBool(json["phoneVerification"],
            fieldName: "phoneVerification"),
        userType: json["userType"] ?? '',
        createdAt: DateTime.parse(json["createdAt"]),
        updatedAt: DateTime.parse(json["updatedAt"]),
        ownedRestaurant: json["ownedRestaurant"] == null
            ? null
            : OwnedRestaurant.fromJson(json["ownedRestaurant"]),
        userToken: json["userToken"] ?? '',
      );
}
...
class OwnedRestaurant {
  ...
  factory OwnedRestaurant.fromJson(Map<String, dynamic> json) =>
      OwnedRestaurant(
        id: json["id"] ?? '',
        title: json["title"] ?? '',
        imageUrl: json["imageUrl"] ?? '',
        ...
        delivery: _parseBool(json["delivery"], fieldName: "delivery"),
        isAvailabe:
            _parseBool(json["isAvailabe"], fieldName: "ownedRes_isAvailable"),
        phone: json["phone"] ?? '',
        code: json["code"],
        accountName: json["accountName"],
        accountNumber: json["accountNumber"],
        ...
        // ✅ Safely handles both null and the new object format
        time: json["time"] == null ? null : Time.fromJson(json["time"]),

        userId: json["userId"] ?? '',
        restaurantCategories: json["restaurant_categories"] == null
            ? null
            : List<RestaurantCategory>.from(json["restaurant_categories"]
...
// ✅ Replaces the old flat Time class
// Matches the new backend structure:
// {
//   "timezone": "Africa/Lagos",
//   "delivery": { "monday": [{ "open": "08:00", "close": "21:00" }], ... },
//   "pickup":   { "monday": [{ "open": "08:00", "close": "15:00" }], ... }
// }
class Time {
  ...
  factory Time.fromJson(Map<String, dynamic> json) {
    Map<String, List<DaySlot>> parseSchedule(dynamic scheduleJson) {
      if (scheduleJson == null || scheduleJson is! Map) return {};
      return scheduleJson.map((day, slots) {
        final slotList =
            (slots as List?)?.map((s) => DaySlot.fromJson(s)).toList() ?? [];
        return MapEntry(day as String, slotList);
      });
    }

    return Time(
      timezone: json["timezone"] ?? "Africa/Lagos",
      delivery: parseSchedule(json["delivery"]),
      pickup: parseSchedule(json["pickup"]),
    );
  }

  // Useful for pre-filling the TimeController when editing
...
class Additive {
  ...
  factory Additive.fromJson(Map<String, dynamic> json) => Additive(
        ...
        min: json["min"] ?? 0,
        isAvailable:
            _parseBool(json["isAvailable"], fieldName: "additive isAvailable"),
      );
}
